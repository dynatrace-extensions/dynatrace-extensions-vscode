...
Ensure you are familiar with this project. Read and obey [instructions.md](../instructions.md).

## PLANNING WORKFLOW

1. **Consult existing plans**:
   - Check the `.ai/plans/` directory for a relevant plan file.
   - Prefer:
     - A task- or feature-specific plan (e.g., `.ai/plans/feature-123-add-billing.md`)
...
3. **If no suitable plan exists**:
   - Create a new plan in `.ai/plans/` that describes what you propose to implement.
